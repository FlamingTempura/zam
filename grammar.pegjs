...
FormatterExpression
  = subject:AssignmentExpression _
    "|" _ formatter:Identifier
    parameter:(_ ":" _ parameter:FormatterExpression { return parameter; })?
    { return { type: "Formatter", formatter: formatter.name, parameter: parameter, subject: subject }; }
...
LogicalORExpression
  = left:LogicalANDExpression _
    "||" _ right:LogicalORExpression
    { return { type: 'Logical', operator: '||', left: left, right: right }; }
  / LogicalANDExpression

LogicalANDExpression
  = left:EqualityExpression _
    "&&" _ right:LogicalANDExpression
    { return { type: 'Logical', operator: '&&', left: left, right: right }; }
  / EqualityExpression

EqualityExpression
  = left:RelationalExpression _
    operator:("===" / "!==" / "==" / "!=") _
...
RelationalExpression
  = left:AdditiveExpression _
    operator:RelationalOperator _
...
AdditiveExpression
  = left:MultiplicativeExpression _
    operator:AdditiveOperator _
...
MultiplicativeExpression
  = left:UnaryExpression _
    operator:MultiplicativeOperator _
...
ArgumentList
  = head:AssignmentExpression
    tail:(_ "," _ arg: AssignmentExpression { return arg; })*
...
ElementList
  = head:AssignmentExpression
    tail:(_ "," _ element:AssignmentExpression { return element; })*
    { return [head].concat(tail); }
